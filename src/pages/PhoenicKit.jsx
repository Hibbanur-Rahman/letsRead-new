    ...
    <div className="w-full flex flex-col items-center justify-center">
      ...
      <div className="md:mt-12 mt-4 md:mb-0 mb-10 w-full flex items-center justify-center">
        <div className="md:w-11/12  md:mt-20">
          ...
          <div className="w-full rounded-3xl rounded-t-none border-[1px] border-[gray] bg-[#FAE5FF] shadow-xl">
            {/** Brief Description */}
            {isDescriptionShow && (
              <div className="w-full md:py-10 md:px-10 flex flex-col items-center justify-center">
                <div className="flex md:flex-row flex-col-reverse md:px-0 px-3 w-full items-center justify-between md:my-2 my-4">
                  <div className="md:w-6/12 w-full flex flex-col justify-start">
                    <h1 className="md:text-2xl text-lg font-bold mb-2">
                      Let's Read provides a dynamic platform for children aged
                      3-4 to seamlessly transition from their native language to
                      English.
                    </h1>
                    <p className="text-gray md:text-lg">
                      Let's Read introduces an immersive kinesthetic activity
                      kit meticulously crafted to make the journey of learning
                      English phonics a delightful adventure for preschoolers.
                      Bursting with an array of hands-on engagements, Let's Read
                      provides a dynamic platform for children aged 3-4 to
                      seamlessly transition from their native language to
                      English. Through captivating games and enchanting stories,
                      children not only forge connections between letter symbols
                      and phonetic sounds but also cultivate fundamental early
                      reading skills, ensuring a captivating and enduring
                      learning experience.
                    </p>
                  </div>
                ...
                <div className="flex md:flex-row flex-col md:px-0 px-3 w-full items-center justify-between my-2">
                  ...
                  <div className="md:w-6/12 w-full flex flex-col  md:items-end md:my-0 my-4">
                    <p className="md:text-lg font-bold md:text-right">
                      ...
                      young children. Within its vibrant pages, a diverse array
                      of interactive activities awaits, each one crafted with
            ...
            {/** Objectives */}
            {isObjectiveShow && (
              <div className="w-full md:py-10 md:px-10 px-3 flex  items-center justify-center">
                  ...
                  <div className="md:w-6/12 w-full md:mt-0 mt-4">
                    ...
                    <ul className="ps-4 md:mt-8">
                      <li className="md:text-lg text-sm  font-bold text-left list-disc my-2">
                        Listening and Speaking: Abundant opportunities for
                        lively conversations and interactive exchanges.
                      </li>
                      <li className="md:text-lg text-sm font-bold text-left list-disc my-2">
                        Story Cards: Facilitating a smooth transition from the
                        familiar contours of their mother tongue to the
                        enchanting vistas of English.
                      </li>
                      <li className="md:text-lg text-sm font-bold text-left list-disc my-2">
                      ...
                      <li className="md:text-lg text-sm font-bold text-left list-disc my-2">
                        Tracing: Nurturing fine motor skills and fostering a
            ...
            {/** Benefits */}
            {isBenefitShow && (
              <div className="w-full md:py-10 py-4 md:px-10 px-3 flex  items-center justify-center">
                <div className="md:w-11/12 w-full flex md:flex-row flex-col-reverse items-center justify-between">
                  <div className="md:w-6/12 w-full">
                    ...
                    <ul className="ps-4 mt-2">
                      ...
                      <li className="md:text-lg text-base text-left list-disc my-2">
                        ...
                        Provides a solid foundation for phonetic literacy,
                        paving the way for confident and articulate
                        communicators.
                      </li>
                      <li className="md:text-lg text-base text-left list-disc my-2">
                        <span className="text-pink md:text-xl font-bold">
                        ...
                         Nurtures a love for language and literature from the
                        very outset, laying the groundwork for a lifelong
            ...
            {/** Contents */}
            {isContentShow && (
              <div className="w-full md:py-10 md:px-10 px-3 py-4 flex  items-center justify-center">
                <div className="md:w-11/12 w-full flex md:flex-row flex-col-reverse items-center justify-between">
                  <div className="md:w-6/12 w-full">
                    <h2 className="md:text-3xl text-2xl font-bold text-left">
                      Contents :
                    ...
                    <p className="md:text-lg md:mt-8 mt-2">
                      Dive into a world of discovery with Let's Read, where
                      every kit is brimming with:{" "}
                    </p>
                    <ul className="ps-4 mt-2">
                      <li className="md:text-lg text-left list-disc my-2">
                        ...
                         Engaging prompts and challenges that spark creativity
                        and imagination.
                      </li>
                      <li className="md:text-lg text-left list-disc my-2">
                        <span className="text-pink md:text-xl font-bold">
                      ...
                      <li className="md:text-lg text-left list-disc my-2">
                        ...
                        Interactive tools that add an extra layer of excitement
                        to learning, turning every activity into an adventure.
                      </li>
                      <li className="md:text-lg text-left list-disc my-2">
                        <span className="text-pink md:text-xl font-bold">
                          And More:
                        </span>
                          Unlock a treasure trove of surprises and delights as
                        you explore the rich tapestry of activities within Let's
                        Read, designed to inspire, engage, and empower young
                        learners on their phonics journey.
                      </li>
                    </ul>
                    <button
            ...
            {/** Gallery */}
            {isGalleryShow && (
              <div className="w-full md:py-10 md:px-10 px-3 py-4 flex flex-col items-center justify-center">
            ...
            <div className="md:flex hidden w-full justify-center gap-[10px] px-3 mb-8">
              {count > 1 ? (
                <button
                  className="w-max text-lg px-10 bg-darkPurple text-white rounded-lg py-2"
